...
namespace Resource.API.Middleware;
...
public class ResponseFilteringMiddleware
{
    ...
    {
        // Only process API responses for authenticated users
    ...
    {
        // Define field-level authorization rules for Resource API
    ...
    {
        // Only filter authenticated API responses, exclude swagger and health endpoints
